...
export function CtaSection() {
  return (
    <section className="relative py-24 md:py-32 px-6 md:px-12 snap-start">
      <motion.div 
      ...
      >
        ...
        <div className="absolute -inset-4 bg-gradient-to-r from-black/5 dark:from-white/10 via-transparent to-black/5 dark:to-white/10 rounded-[3rem] blur-3xl opacity-50 group-hover:opacity-80 transition-opacity duration-1000 pointer-events-none" />
        ...
        >
          ...
          <div className="relative inline-flex items-center justify-center mb-8">
            <Sparkles className="w-12 h-12 text-text-primary drop-shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" strokeWidth={1} />
          </div>
